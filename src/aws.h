...
struct connection {
	...
	// Pentru ca pe forum s-a mentionat ca nu exista nicio limitare la citirea de date asincron
	// si ca putem modifica structura conneciton, am decis se adaug un buffer dinamic caruia i se aloca
	// destula memorie pentru a citi tot fisierul intr-o singura tura.
	char *dynamic_buffer;
